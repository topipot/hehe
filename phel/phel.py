...
class ScanUser:
    def __init__(self, parent_window=None):
        ...
        self.qr_data_label.place(x=190, y=360)
        script_dir = os.path.dirname(os.path.abspath(__file__))
...
class QRCodeScanner:
    def __init__(self, parent_window=None, selected_shelf=""):
        ...
        self.Homie.place(x =10 , y = 410, width = 30, height = 23)
...
class Borrow:
    def __init__(self, parent_window=None):
        ...
        self.qr_data_label = Label(self.window, text="QR Code Data:", font=custom_font)
        ...
        imgbook2 = PhotoImage(file=os.path.join(script_dir, "BorrowBook.png"))
        self.BookBorrow = Button(
            ...
            relief = "flat")
        self.BookBorrow.place(x = 440, y = 360, width = 158, height = 75)
...
class Return:
    def __init__(self, parent_window=None):
        ...
        imgbook2 = PhotoImage(file=os.path.join(script_dir, "Rb.png"))
        self.BookBorrow = Button(
            self.canvas,
            image = imgbook2,
            borderwidth = 0,
...
class FirstWindow:
    def __init__(self, parent_window=None):
        ...
        self.b3.place(x=258, y=310, width=123, height=25)
        self.b3.image= img3
...
class MainApplication(tk.Toplevel):
    def __init__(self, parent_window):
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        image_path = os.path.join(script_dir, "selectshelf.png")
        ...
        self.Home.place(x = 80, y = 125, width = 40, height = 39)
        ...
        self.combo_box.place(x=170, y=150, width=297, height=39)
